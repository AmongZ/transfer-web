<template>
    <div>
        ...
        <el-dialog :visible.sync="dialogFormVisible">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="归属部门" prop="teamName">
                    <el-input v-model="ruleForm.teamName" placeholder="请输入归属部门"></el-input>
                </el-form-item>
        ...
        <el-card>
            <div>
                <el-row :gutter="8">
                    <el-col :span="4" style="height: 118px" v-for="(item, index) in platformData" :key="index0">
            ...
            this.$axios
                ...
                .then(response => {
                    ...
                    for (let i of this.platformData) {
                        i.desc = i.platformDesc + '（' + i.teamName + '）';
                    }
                })
                .catch(error => {
                    console.log(error);
